...
const Header = () => {
  ...
  return (
    <header className='py-6 shadow-header dark:text-white dark:bg-lightDark '>
      <div className="flex justify-between items-center w-full max-w-[1320px] px-5 mx-auto">
        ...
        <button onClick={toggleDarkMode} className='inline-flex items-center tex-base dark:text-white font-semibold text-textColor ml-8'>
